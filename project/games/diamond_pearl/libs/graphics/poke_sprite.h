...
static inline void set_sprite_hooks() {
  // function at 0x20082A8

  // bl 0x023aa800, loadSpriteFromNarc
  write_u32_16bit_alligned((u16 *)0x020082ee, 0xfa87f3a2); // + 0x46
  // bl 0x023aa900, loadOrInjectSprite
  write_u32_16bit_alligned((u16 *)0x02008312, 0xfaf5f3a2); // + 0x6A

  // function at 0x20086F4
  // bl 0x023aa980, loadOrInjectPalette
  write_u32((u32 *)0x02008744, 0xf91cf3a2); // + 0x50
}
