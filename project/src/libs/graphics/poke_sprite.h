...
static inline void set_sprite_hooks() {
  ...
  // sprite_inject_hook: bl 0x023c5100, loadOrInjectSprite
  write_u32_16bit_alligned((u16 *)0x0200956A, 0xfdc9f3bb);

  // palette_inject_hook: bl 0x023c5200, loadOrInjectPalette
...
static inline void loadSpriteFromNarc() {
  WITH_CURRENT_REGSTATE(NNS_G2dGetUnpackedCharacterData, 2);
